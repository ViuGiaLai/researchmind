...
def cache_fingerprint(
    *, model: str, provider: str, prompt: str, context: str, paper_versions: dict | None = None
) -> str:
    payload = {
        ...
        "provider": provider,
        "prompt": prompt,
        "context_hash": hashlib.sha256((context or "").encode()).hexdigest(),
        "papers": paper_versions or {},
    }
